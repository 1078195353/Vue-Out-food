        ...
        <section class="loginContainer">
            <div class="loginInner">
                    ...
                    <form>
                        <div class="on">
                            ...
                            <section class="login_hint">
                                温馨提示：未注册华师外卖帐号的手机号，登录时将自动注册，且代表已同意
                ...
                <a href="javascript:" class="go_back" @click = "goBack">
                    <i class="iconfont iconjiantou-copy" style="font-size: 22px; float: left; margin: 10px;"></i>
                </a>
            </div>
        </section>
    </div>
...
<style>
    ...
    #app>.on .loginContainer .loginInner .login_header .login_header_title>a.on {
        color: #03556D;
        font-weight: 700;
        border-bottom: 2px solid #03556D;
    }
